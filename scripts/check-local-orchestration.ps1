...
Assert-ContainsLiteral $start 'Validate Recommendation runtime schema' 'Recommendation read-only schema preflight'
Assert-ContainsLiteral $start 'ForFakebook.schema_preflight' 'Recommendation exact schema validator preflight'
Assert-ContainsLiteral $start 'waiting for readiness' 'service launch versus readiness status distinction'
