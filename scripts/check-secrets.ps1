...
$secretNames = @(
    'DB_PASSWORD', 'JWT_PRIVATE_KEY_BASE64', 'JWT_LEGACY_SIGNING_KEY', 'GATEWAY_SHARED_SECRET',
    ...
    'SEARCH_DB_PASSWORD', 'NOTIFICATION_DB_PASSWORD', 'MESSENGER_DB_PASSWORD',
    'PAYMENT_DB_PASSWORD', 'SMTP_PASSWORD', 'PAYOS_API_KEY', 'PAYOS_CHECKSUM_KEY'
)
